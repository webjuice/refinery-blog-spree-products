...
function ResponsiveModalDialog(argsArray) {
  ...
  jQuery(function(){  
    ...
    window_position = typeof argsArray['window_position'] !== 'undefined' ? argsArray['window_position'] : 'auto';
...
jQuery.fn.ModalWindowPoistioning = function (window_position) {
  if ( (calc_dialog_height < screen_height) && (window_position == 'auto') || (window_position == 'fixed') ) {
    return this
      .css('position', 'fixed')
